...
# FILE: DOWNLOADING AND PROCESSING RAW DATA
# AUTHOR: NINO CRICCO
# CONTACT: ncricco@g.harvard.edu
#------------------------------------------------------------------------------

# Attribution: I drew the structure of this file from code developed by 
# Ian Lundberg (thanks Ian!), posted in the Harvard dataverse here: 
# https://doi.org/10.7910/DVN/JERJ0C

source("jobs/0-libraries.R")

# Analyzing PSID data: data cart available on https://psidonline.isr.umich.edu/
# Register, then go to data-> data center-> previous carts
# enter email address ncricco@g.harvard.du
# Download cart 328628	-	Dissertation File 25.01.2024
# Load in Stata, run dofile, save .dta file to working directory as psid.dta
...
main.psid <- read_dta("data/psid.dta") %>%
  mutate(familyid = ER30001, # 1968 interview number
         ...
         person = paste0(familyid,"_",person_number), # unique individual id
         sex = ER32000) %>%
  # Restrict to Sample Members (original sample individuals + descendants)
  filter(person_number < 170)

# Adjust for inflation using the Consumer Price Index for All Urban Consumers
# https://data.bls.gov/timeseries/CUUR0000SA0 from 1967 to 2019
cpi <- readxl::read_xlsx("data/cpi.xlsx",
  ...
  group_by() %>%
  rename(year = Year) %>%
  # Adjust to 2022 US dollars
  mutate(cpi_2022 = mean(ifelse(year == 2019, cpi, NA), na.rm = T),
         to_multiply = cpi_2022 / cpi) %>%
  select(year, to_multiply) %>%
  # Add 1 to year, PSID data is reported for income earned in previous year
  mutate(year = year + 1)
...
clean <- function(string, data = main.psid, 
                  years.data = years, varName = varName) {
  ...
  df_years_varNames <- (foreach(
    x = vector_of_variables, .combine = "rbind") %do% {
  ...
  # Produce a tidy data frame of this variable, with rows by person and year
...
# Run cleaning code on selected variables to produce raw data
unrestricted <- clean("[68]ER30004 [69]ER30023 [70]ER30046 [71]ER30070 [72]ER30094 [73]ER30120 [74]ER30141 [75]ER30163 [76]ER30191 [77]ER30220 [78]ER30249 [79]ER30286 [80]ER30316 [81]ER30346 [82]ER30376 [83]ER30402 [84]ER30432 [85]ER30466 [86]ER30501 [87]ER30538 [88]ER30573 [89]ER30609 [90]ER30645 [91]ER30692 [92]ER30736 [93]ER30809 [94]ER33104 [95]ER33204 [96]ER33304 [97]ER33404 [99]ER33504 [01]ER33604 [03]ER33704 [05]ER33804 [07]ER33904 [09]ER34004 [11]ER34104 [13]ER34204 [15]ER34305 [17]ER34504 [19]ER34704 [21]ER34904",
  ...
  left_join(
    clean("[68]ER30019 [69]ER30042 [70]ER30066 [71]ER30090 [72]ER30116 [73]ER30137 [74]ER30159 [75]ER30187 [76]ER30216 [77]ER30245 [78]ER30282 [79]ER30312 [80]ER30342 [81]ER30372 [82]ER30398 [83]ER30428 [84]ER30462 [85]ER30497 [86]ER30534 [87]ER30569 [88]ER30605 [89]ER30641 [90]ER30688 [91]ER30732 [92]ER30805 [93]ER30866 [94]ER33121 [95]ER33277 [96]ER33318 [97]ER33438 [99]ER33547 [01]ER33639 [03]ER33742 [05]ER33849 [07]ER33951 [09]ER34046 [11]ER34155 [13]ER34269 [15]ER34414 [17]ER34651 [19]ER34864 [21]ER35065",
          varName = "weight_crosssec_coreimm"),
    by = c("person", "year")
  ) %>%
  left_join(
    clean("[68]ER30019 [69]ER30042 [70]ER30066 [71]ER30090 [72]ER30116 [73]ER30137 [74]ER30159 [75]ER30187 [76]ER30216 [77]ER30245 [78]ER30282 [79]ER30312 [80]ER30342 [81]ER30372 [82]ER30398 [83]ER30428 [84]ER30462 [85]ER30497 [86]ER30534 [87]ER30569 [88]ER30605 [89]ER30641 [90]ER30688 [91]ER30732 [92]ER30805 [93]ER30866 [94]ER33121 [95]ER33277 [96]ER33318 [97]ER33430 [99]ER33546 [01]ER33637 [03]ER33740 [05]ER33848 [07]ER33950 [09]ER34045 [11]ER34154 [13]ER34268 [15]ER34413 [17]ER34650 [19]ER34863 [21]ER35064",
          varName = "weight_long_coreimm"),
    by = c("person", "year")
  ) %>%
  left_join(
  ...
  left_join(main.psid %>% select(person, familyid, sex), by = "person")